...
func TestAddGetDelete(t *testing.T) {
	...
	res, err := store.Get(int(id)) // Приведение id к типу int, если нужно
	require.NoError(t, err)

	// Для сравнения нужно присвоить идентификатор добавленной записи в структуру parcel
